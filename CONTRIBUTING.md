...
Add this automatically with `git commit --signoff` (or `-s`). By including this line, you certify that:

- The contribution is your original work, OR
- You have the right to submit it under the project license, AND
- You understand and agree to the terms of the [Developer Certificate of Origin](https://developercertificate.org/).

**Do not include AI attribution or "Generated by" lines in commit messages or PR descriptions.**
